  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <p>Aquí puedes personalizar los precios de cada lugar de estacionamiento en las diferentes ubicaciones.</p>
        </CardContent>
      </Card>
                            ...
                            <td className="border p-2">
                              <div className={`flex ${isMobile ? "flex-col space-y-2" : "space-x-2"}`}>
                                ...
                                >
                                  ...
                                  <span className={isMobile ? "ml-1" : ""}>Editar precio</span>
                                </Button>
                                <Button
                                  variant="outline"
                                  size="sm"
                                ...
                                >
                                  ...
                                  <span className={isMobile ? "ml-1" : ""}>Ver reservas</span>
                                </Button>
                              </div>
                            </td>
                          </tr>
        ...
        <Dialog open={!!editingSpot} onOpenChange={(open) => !open && setEditingSpot(null)}>
          <DialogContent className="w-[95%] max-w-md mx-auto">
            ...
            <DialogFooter className="flex-col sm:flex-row gap-2">
              <Button variant="outline" onClick={() => setEditingSpot(null)} className="w-full sm:w-auto">
                <X className="h-4 w-4 mr-2" />
                Cancelar
              </Button>
              <Button onClick={handleUpdatePrice} className="w-full sm:w-auto">
